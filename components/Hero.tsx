      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className=" max-w-[89vw]   flex flex-col items-center justify-center">
          ...
          <div className="flex justify-center items-baseline gap-4">
            ...
            <a href="https://drive.google.com/file/d/1ZNTtkyebvdtgW2ZXd-grJKJtxLDc7Mht/view" target="_blank"><div  className=" inline-flex h-12 animate-shimmer items-center justify-center rounded-md border border-slate-800 bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] px-6 font-medium text-white transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
              Resume
            </div></a>
          </div>
        </div>
